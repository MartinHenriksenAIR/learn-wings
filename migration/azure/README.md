...
| `11-org-entra-tenant.sql` | Additive, idempotent migration for #353 (`organizations.entra_tid` + `entra_tid_label` — SSO tenant auto-join binding). Slot `10` is `10-course-categories.sql` (#361), which merges first. |
| `README.md`     | This file. |
