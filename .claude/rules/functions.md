...
- **Function/route names may NOT start with `admin`, `runtime`, or `host`** (reserved prefixes; also pinned by the fleet guard). Use suffix style: `user-actions-admin`, `course-admin`.
