...
describe('buildPublicUrl', () => {
  ...
  it('composes base, the public container segment, and path with a single separator', () => {
    vi.stubEnv('VITE_STORAGE_BASE_URL', 'https://example.com/storage');
    expect(buildPublicUrl('org-logos/123.png')).toBe('https://example.com/storage/email-assets/org-logos/123.png');
  });
