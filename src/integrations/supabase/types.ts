  ...
  public: {
    Tables: {
      ai_champions: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_champions_assigned_by_fkey"
            columns: ["assigned_by"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "ai_champions_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "ai_champions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      ai_conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_conversations_idea_id_fkey"
            columns: ["idea_id"]
            isOneToOne: false
      ...
      idea_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "idea_categories_parent_id_fkey"
            columns: ["parent_id"]
            isOneToOne: false
      ...
      idea_comments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "idea_comments_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      idea_evaluations: {
        ...
        Relationships: [
          {
            foreignKeyName: "idea_evaluations_evaluated_by_fkey"
      ...
      idea_specifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "idea_specifications_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "idea_specifications_idea_id_fkey"
            columns: ["idea_id"]
            isOneToOne: false
            referencedRelation: "ideas"
            referencedColumns: ["id"]
      ...
      idea_votes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "idea_votes_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      ideas: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ideas_course_context_id_fkey"
            columns: ["course_context_id"]
            isOneToOne: false
            referencedRelation: "courses"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "ideas_lesson_context_id_fkey"
            columns: ["lesson_context_id"]
            isOneToOne: false
